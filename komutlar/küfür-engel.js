...
exports.run = async (bot, message, args) => {
  ...
  if (args[0] == "aç") {
    ...
    message.channel.send(
      "Küfür Engel başarıyla açıldı! `Üyeleri Yasakla` yetkisine sahip olanların küfür engellenmiyecektir."
    );
  }
  ...
  if (args[0] == "kapat") {
    ...
    message.channel.send(
      "Küfür Engel başarıyla kapatıldı! Artık herkes küfür yapabilir."
    );
  }
};
